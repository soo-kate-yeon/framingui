...
export class ArchetypeTools {
  ...
  async initialize(): Promise<void> {
    ...
    try {
      ...
      const archetypeData = await import("@tekton/archetype-system/data");

      this.propRules = archetypeData.hookPropRulesData || [];
      this.stateMappings = archetypeData.stateStyleMappingsData || [];
      this.variants = archetypeData.variantBranchingData || [];
      this.structures = archetypeData.structureTemplatesData || [];
