...
const breadcrumbEllipsisVariants = cva('inline-flex h-9 w-9 items-center justify-center text-[var(--tekton-text-muted-foreground)]', {
    variants: {},
});
const Breadcrumb = React.forwardRef(({ className, size, separator: _separator = '/', ...props }, ref) => {
    return (<nav ref={ref} aria-label="breadcrumb" className={cn(breadcrumbVariants({ size, className }))} {...props}/>);
});
Breadcrumb.displayName = 'Breadcrumb';
const BreadcrumbList = React.forwardRef(({ className, ...props }, ref) => (<ol ref={ref} className={cn(breadcrumbListVariants({ className }))} {...props}/>));
...
const BreadcrumbPage = React.forwardRef(({ className, ...props }, ref) => (<span ref={ref} role="link" aria-disabled="true" aria-current="page" className={cn(breadcrumbLinkVariants({ active: true }), 'text-[var(--tekton-bg-foreground)]', className)} {...props}/>));
BreadcrumbPage.displayName = 'BreadcrumbPage';
const BreadcrumbSeparator = React.forwardRef(({ children, className, ...props }, ref) => (<li ref={ref} role="presentation" aria-hidden="true" className={cn(breadcrumbSeparatorVariants({ className }))} {...props}>
      {children ?? '/'}
    </li>));
BreadcrumbSeparator.displayName = 'BreadcrumbSeparator';
const BreadcrumbEllipsis = React.forwardRef(({ className, ...props }, ref) => (<span ref={ref} role="presentation" aria-hidden="true" className={cn(breadcrumbEllipsisVariants({ className }))} {...props}>
