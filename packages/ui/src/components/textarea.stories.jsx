...
export const Disabled = {
    render: () => (<div className="grid w-full gap-1.5">
      ...
      <Textarea placeholder="Type your message here." id="disabled" disabled value="This textarea is disabled."/>
    </div>),
};
/**
 * With error state
...
export const WithError = {
    render: () => (<div className="grid w-full gap-1.5">
      ...
      <Textarea placeholder="Type your message here." id="message-error" className="border-[var(--tekton-bg-destructive)]" aria-invalid="true" aria-describedby="message-error-text"/>
...
export const WithCharacterCount = {
    render: () => {
        ...
        <Textarea placeholder="Tell us about yourself" id="bio" value={value} onChange={e => setValue(e.target.value)} maxLength={maxLength}/>
...
export const FormExample = {
    render: () => (<div className="w-full max-w-sm space-y-4">
      <div className="grid gap-1.5">
        ...
        <input type="text" id="subject" placeholder="Enter subject" className="flex h-10 w-full rounded-md border border-[var(--tekton-border-input)] bg-transparent px-3 py-2 text-sm"/>
      </div>
      <div className="grid gap-1.5">
