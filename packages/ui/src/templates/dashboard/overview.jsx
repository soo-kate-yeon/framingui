...
export function DashboardTemplateComponent({ children, className = '', slots = {}, texts = {}, }) {
    ...
    return (<div className={`min-h-screen flex ${className}`}>
      {/* Sidebar */}
      {slots.sidebar && (<aside className="w-64 border-r border-[var(--tekton-border-default)] bg-[var(--tekton-bg-card)] hidden lg:block">
          {slots.sidebar}
        </aside>)}
      ...
      <main className="flex-1 overflow-auto bg-[var(--tekton-bg-background)]">
        ...
        <div className="py-[var(--tekton-layout-section-py,var(--tekton-spacing-6))] px-[var(--tekton-layout-container-px,var(--tekton-spacing-6))] space-y-[var(--tekton-layout-stack-gap,var(--tekton-spacing-6))] max-w-[var(--tekton-layout-container-xl)] mx-auto">
          {/* Metrics Row */}
          {slots.metrics && (<div className="grid gap-[var(--tekton-spacing-4)] grid-cols-2 lg:grid-cols-4">
              {slots.metrics}
            </div>)}
          ...
          <div className="grid gap-x-[var(--tekton-layout-grid-gap-x,var(--tekton-spacing-6))] gap-y-[var(--tekton-layout-grid-gap-y,var(--tekton-spacing-6))] lg:grid-cols-12">
            ...
            {slots.primaryContent && (<div className="lg:col-span-8 space-y-[var(--tekton-layout-stack-gap,var(--tekton-spacing-6))]">
            ...
            {slots.secondaryContent && (<div className="lg:col-span-4 space-y-[var(--tekton-layout-stack-gap,var(--tekton-spacing-6))]">
