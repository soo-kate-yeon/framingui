...
- Added the server-safe `@framingui/ui/theme-loader` subpath export so Next.js API routes can load theme CSS helpers without importing the client entrypoint.

### Testing

- Covered the new server-safe theme loader path through hosted CSS route regression tests.
