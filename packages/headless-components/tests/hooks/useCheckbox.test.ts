...
describe('useCheckbox', () => {
  ...
  describe('Initialization', () => {
    ...
    it('should use custom ID when provided', () => {
      const { result } = renderHook(() => useCheckbox({ id: 'custom-checkbox' }));
  ...
  describe('Controlled Mode', () => {
    ...
    it('should call onChange when toggled', () => {
      ...
      const { result } = renderHook(() => useCheckbox({ checked: false, onChange }));
  ...
  describe('ARIA Attributes', () => {
    ...
    it('should set aria-checked based on checked state', () => {
      ...
      const { result: checkedResult } = renderHook(() => useCheckbox({ checked: true }));
      expect(checkedResult.current.checkboxProps['aria-checked']).toBe(true);
    });

    it('should include aria-label when provided', () => {
      const { result } = renderHook(() => useCheckbox({ 'aria-label': 'Accept terms' }));
