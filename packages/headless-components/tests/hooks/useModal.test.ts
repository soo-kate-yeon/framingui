...
describe("useModal", () => {
  ...
  describe("Open/Close State", () => {
    ...
    it("should call onClose when closed", () => {
      ...
      const { result } = renderHook(() =>
        useModal({ defaultOpen: true, onClose }),
      );
  ...
  describe("Escape Key", () => {
    it("should close on Escape key when closeOnEscape=true", () => {
      const { result } = renderHook(() =>
        useModal({ defaultOpen: true, closeOnEscape: true }),
      );
    ...
    it("should not close on Escape when closeOnEscape=false", () => {
      const { result } = renderHook(() =>
        useModal({ defaultOpen: true, closeOnEscape: false }),
      );
    ...
    it("should call onClose when closed via Escape", () => {
      const onClose = vi.fn();
      const { result } = renderHook(() =>
        useModal({ defaultOpen: true, onClose, closeOnEscape: true }),
      );
  ...
  describe("Overlay Click", () => {
    it("should close on overlay click when closeOnOverlayClick=true", () => {
      const { result } = renderHook(() =>
        useModal({ defaultOpen: true, closeOnOverlayClick: true }),
      );
    ...
    it("should not close when closeOnOverlayClick=false", () => {
      const { result } = renderHook(() =>
        useModal({ defaultOpen: true, closeOnOverlayClick: false }),
      );
    ...
    it("should call onClose when closed via overlay click", () => {
      const onClose = vi.fn();
      const { result } = renderHook(() =>
        useModal({ defaultOpen: true, onClose, closeOnOverlayClick: true }),
      );
  ...
  describe("Focus Trap", () => {
    ...
    it("should handle Tab key without error when trapFocus=true", () => {
      const { result } = renderHook(() =>
        useModal({ trapFocus: true, defaultOpen: true }),
      );
    ...
    it("should handle Tab key without error when trapFocus=false", () => {
      const { result } = renderHook(() =>
        useModal({ trapFocus: false, defaultOpen: true }),
      );
  ...
  describe("Focus Restoration", () => {
    ...
    it("should call focus on trigger when closing with restoreFocus=true", () => {
      ...
      const { result } = renderHook(() =>
        useModal({ defaultOpen: false, restoreFocus: true }),
      );
    ...
    it("should not restore focus when restoreFocus=false", () => {
      ...
      const { result } = renderHook(() =>
        useModal({ defaultOpen: false, restoreFocus: false }),
      );
  ...
  describe("ARIA Attributes", () => {
    ...
    it("should set aria-label when provided", () => {
      const { result } = renderHook(() =>
        useModal({ ariaLabel: "Custom Modal" }),
      );
    ...
    it("should set aria-labelledby when provided", () => {
      const { result } = renderHook(() =>
        useModal({ ariaLabelledBy: "modal-title" }),
      );
    ...
    it("should set aria-describedby when provided", () => {
      const { result } = renderHook(() =>
        useModal({ ariaDescribedBy: "modal-description" }),
      );

      expect(result.current.modalProps["aria-describedby"]).toBe(
        "modal-description",
      );
    });
