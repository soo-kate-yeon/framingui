...
describe("useDivider", () => {
  ...
  describe("Orientation", () => {
    ...
    it("should support vertical orientation", () => {
      const { result } = renderHook(() =>
        useDivider({ orientation: "vertical" }),
      );
    ...
    it("should set aria-orientation for semantic dividers", () => {
      ...
      expect(result.current.dividerProps["aria-orientation"]).toBe(
        "horizontal",
      );
    });
  ...
  describe("Decorative Mode", () => {
    ...
    it("should return isDecorative flag", () => {
      const { result: decorative } = renderHook(() =>
        useDivider({ decorative: true }),
      );
      expect(decorative.current.isDecorative).toBe(true);

      const { result: semantic } = renderHook(() =>
        useDivider({ decorative: false }),
      );
  ...
  describe("Semantic Mode", () => {
    ...
    it("should include aria-label when label provided", () => {
      const { result } = renderHook(() =>
        useDivider({ label: "Section divider" }),
      );
    ...
    it("should include aria-orientation when semantic", () => {
      const { result } = renderHook(() =>
        useDivider({ decorative: false, orientation: "vertical" }),
      );
