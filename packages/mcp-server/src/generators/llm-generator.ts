...
import { getComponentSchema, type ComponentSchema } from '@framingui/core';
...
export function buildLLMContext(
  ...
  let prompt = `Generate a React component following @framingui/ui conventions.
