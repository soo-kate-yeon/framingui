  ...
  return (
    <Select value={locale} onValueChange={(value) => setLocale(value as GlobalLocale)}>
      <SelectTrigger
        ...
        } w-[110px] sm:w-[120px] inline-flex items-center justify-between rounded-full border border-neutral-200 bg-white text-sm font-sans font-medium tracking-tight text-neutral-950 shadow-none outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-100 ${className}`}
      >
