...
export const TEMPLATE_DOCS: Record<string, TemplateDocsData> = {
  'square-minimalism': {
    ...
    philosophy: {
      ...
      description:
        'Square Minimalism은 모든 요소에서 둥근 모서리를 완전히 제거하고, 타이포그래피와 여백을 통해 구조를 표현하는 디자인 시스템입니다.',
      principles: [
    ...
    designDetails: [
      ...
      {
        title: '선택적 투명도',
        description: 'Glass morphism 효과를 사용할 때는 80% 불투명도와 backdrop-blur를 적용합니다.',
      },
      {
        title: '대문자 강조',
        description: '중요한 레이블과 버튼은 uppercase + wide tracking으로 강조합니다.',
      },
    ],
    tocSections,
  },
  'equinox-fitness': {
    ...
    philosophy: {
      tagline: '에너지를 시각화하다',
      description:
        'Equinox Fitness는 운동의 역동성과 에너지를 시각 언어로 표현한 디자인 시스템입니다.',
      principles: [
  ...
  'round-minimal': {
    ...
    philosophy: {
      tagline: '부드러움 속의 명료함',
      description:
        'Round Minimal은 부드러운 곡선과 온화한 컬러로 친근하면서도 전문적인 인상을 전달합니다.',
      principles: [
  ...
  'classic-magazine': {
    ...
    philosophy: {
      ...
      description:
        'Classic Magazine은 인쇄 매체의 우아한 레이아웃과 타이포그래피를 웹으로 가져온 디자인 시스템입니다.',
      principles: [
  ...
  'minimal-workspace': {
    ...
    philosophy: {
      tagline: '집중을 위한 공간',
      description:
        'Minimal Workspace는 생산성과 집중력을 극대화하기 위해 불필요한 요소를 철저히 배제한 디자인 시스템입니다.',
      principles: [
