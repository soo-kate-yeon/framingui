  ...
  'equinox-fitness': {
    ...
    colorTokens: [
      {
        ...
        nameKo: '에너지 오렌지',
        hex: '#FF5722',
        usage: 'Primary CTA buttons, active states',
        usageKo: '주요 CTA 버튼, 활성 상태',
      },
      {
        name: 'Deep Purple',
        nameKo: '딥 퍼플',
    ...
    designDetails: [
      ...
      },
      {
        ...
        titleKo: '둥근 모서리',
        description:
          '12px border-radius creates a modern, approachable feel while maintaining professional aesthetics.',
        descriptionKo:
          '12px border-radius는 전문적인 미학을 유지하면서 현대적이고 친근한 느낌을 만듭니다.',
      },
    ],
    customization: [
      {
  ...
  'classic-magazine': {
    ...
    colorTokens: [
      ...
      },
      {
        ...
        nameKo: '웜 화이트',
        hex: '#FFFEF7',
        usage: 'Page background (subtle off-white)',
        usageKo: '페이지 배경 (미묘한 오프화이트)',
      },
      {
        name: 'Accent Gold',
        nameKo: '액센트 골드',
        hex: '#B8860B',
        usage: 'Highlights, pull quotes',
        usageKo: '하이라이트, 인용구',
      },
      {
        name: 'Muted Gray',
    ...
    colorTokens: [
      {
        ...
        nameKo: '뉴트럴 800',
        hex: '#262626',
        usage: 'Primary text (AAA contrast)',
        usageKo: '주요 텍스트 (AAA 대비)',
      },
      {
        name: 'Neutral 600',
        nameKo: '뉴트럴 600',
      ...
      },
      {
        ...
        nameKo: '블루 A11y',
        hex: '#0066CC',
        usage: 'Links (WCAG AAA compliant)',
        usageKo: '링크 (WCAG AAA 준수)',
      },
    ],
    typographyTokens: [
      {
  ...
  'minimal-workspace': {
    ...
    components: [
      ...
      },
      {
        name: 'CommandPalette',
        nameKo: '커맨드 팔레트',
        description: 'Keyboard-driven command palette (Cmd+K) for quick actions.',
        descriptionKo: '빠른 액션을 위한 키보드 기반 커맨드 팔레트(Cmd+K)입니다.',
        example: '<CommandPalette onCommand={handleCommand} />',
      },
    ],
    designDetails: [
      {
