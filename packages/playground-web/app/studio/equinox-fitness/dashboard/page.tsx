  ...
  return (
    <div className="p-8 max-w-[1600px] mx-auto">
      ...
      <div className="bg-transparent border border-neutral-800 p-8 mb-8">
        ...
        <p className="text-sm text-neutral-400 mt-4">1 more workout to hit your weekly goal</p>
      </div>
      ...
      <div className="grid grid-cols-12 gap-8">
              ...
              <div key={i} className="flex-1 flex flex-col items-center gap-2">
                <div
                  className={`w-full transition-all duration-300 group relative ${
                    item.value === 0 ? 'bg-neutral-800/50' : 'bg-white/10 hover:bg-white'
                  }`}
        ...
        <div className="col-span-4 bg-black border border-neutral-800 p-6">
          ...
          <div className="space-y-4">
            ...
            />
            <WorkoutItem type="Cycling" duration="30 min" calories="280" time="2 days ago" />
            <WorkoutItem type="Yoga Flow" duration="45 min" calories="150" time="3 days ago" />
          </div>
