...
const MINIMAL_WORKSPACE_FALLBACK: Record<string, string> = {
  ...
  '--bg-foreground': '#09090B',
  '--bg-card': '#FFFFFF',
  '--bg-card-foreground': '#09090B',
  '--bg-popover': '#FFFFFF',
  '--bg-popover-foreground': '#09090B',
  '--bg-primary': '#18181B',
  '--bg-primary-foreground': '#FAFAFA',
  '--bg-secondary': '#F4F4F5',
  '--bg-secondary-foreground': '#18181B',
  '--bg-muted': '#F4F4F5',
  '--bg-muted-foreground': '#71717A',
  '--bg-accent': '#F4F4F5',
  '--bg-accent-foreground': '#18181B',
  '--bg-destructive': '#EF4444',
  '--bg-destructive-foreground': '#FAFAFA',
  '--border-input': '#E4E4E7',
  '--border-ring': '#18181B',
        ...
        <div className="md:hidden absolute inset-x-0 top-[104px] bottom-0 bg-[var(--bg-surface)] z-50 overflow-y-auto shadow-xl">
          <nav className="flex flex-col gap-2 p-4">
            ...
            <Link
              ...
              className="text-lg font-medium px-4 py-4 rounded-[var(--radius-lg)] transition-colors text-left text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-canvas)] flex items-center justify-between"
            >
              <span>{locale === 'ko' ? '이슈 트래커' : 'Issue Tracker'}</span>
