...
export const metadata: Metadata = {
  title: 'Installation | framingui',
  description: 'Install framingui with npm, pnpm, or yarn.',
};
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="text-neutral-600">
              <tr className="border-b border-neutral-100">
                <td className="py-3 pr-4 font-mono text-sm">@framingui/core</td>
                <td className="py-3">Token generation, theme parsing, OKLCH utilities</td>
              </tr>
              <tr className="border-b border-neutral-100">
                <td className="py-3 pr-4 font-mono text-sm">@framingui/ui</td>
                <td className="py-3">30+ React components with theme support</td>
              </tr>
              <tr className="border-b border-neutral-100">
                <td className="py-3 pr-4 font-mono text-sm">@framingui/tokens</td>
                <td className="py-3">Raw design tokens (colors, typography, spacing)</td>
              </tr>
              <tr className="border-b border-neutral-100">
                <td className="py-3 pr-4 font-mono text-sm">@framingui/mcp-server</td>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <pre className="bg-neutral-900 text-neutral-100 p-4 rounded-lg overflow-x-auto">
              <code>npm install @framingui/ui @framingui/core</code>
            </pre>
          </div>
          ...
          <div className="space-y-2">
            ...
            <pre className="bg-neutral-900 text-neutral-100 p-4 rounded-lg overflow-x-auto">
              <code>pnpm add @framingui/ui @framingui/core</code>
            </pre>
          </div>
          ...
          <div className="space-y-2">
            ...
            <pre className="bg-neutral-900 text-neutral-100 p-4 rounded-lg overflow-x-auto">
              <code>yarn add @framingui/ui @framingui/core</code>
            </pre>
          </div>
        </div>
      </section>
