        ...
        <main className="min-h-screen py-16 px-6 font-sans" style={{ backgroundColor: canvasColor, color: textColorPrimary }}>
            <div className="max-w-xl mx-auto flex flex-col gap-10 pb-32">
                ...
                <header className="px-4 flex items-center gap-6">
                    ...
                    <h1 className="text-4xl font-black tracking-tighter" style={{ color: textColorPrimary }}>Account</h1>
                </header>
                ...
                <section className="bg-white rounded-[40px] p-10 shadow-[0_12px_48px_rgba(0,0,0,0.06)] flex flex-col items-center gap-6">
                    ...
                    <div className="text-center">
                        <h2 className="text-3xl font-black" style={{ color: textColorPrimary }}>Soo Yeon</h2>
                    ...
                    <p className="text-xl font-medium text-center leading-relaxed max-w-sm opacity-70">
                        Building beautiful experiences with Tekton. Passionate about minimal UI and round corners.
                    </p>
                ...
                <section className="flex flex-col gap-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {[1, 2, 3, 4].map(i => (
                            <div key={i} className="aspect-square bg-white rounded-[32px] shadow-sm overflow-hidden hover:scale-[1.02] transition-transform cursor-pointer">
                                <img src={`https://picsum.photos/seed/${i + 10}/400/400`} alt={`Post ${i}`} className="w-full h-full object-cover opacity-90" />
                            </div>
                        ))}
                    </div>
                </section>
            ...
            <nav className="fixed bottom-8 left-1/2 -translate-x-1/2 w-[calc(100%-48px)] max-w-md bg-white/80 backdrop-blur-xl rounded-[40px] p-4 shadow-[0_20px_50px_rgba(0,0,0,0.1)] flex justify-around items-center border border-white/20">
                <a href="/social-feed" className="w-14 h-14 rounded-full flex items-center justify-center text-neutral-400 hover:bg-neutral-100 transition-colors">
