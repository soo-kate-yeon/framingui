      ...
      <div className="max-w-xl mx-auto flex flex-col gap-10 pb-32">
        ...
        <article className="bg-white rounded-[40px] p-10 shadow-[0_12px_48px_rgba(0,0,0,0.06)] flex flex-col gap-8">
          <div className="flex items-center gap-5">
            ...
            <div>
              <h3 className="text-2xl font-black" style={{ color: textColorPrimary }}>
                Alex Doe
              </h3>
          ...
          <div className="h-[400px] rounded-[32px] overflow-hidden bg-neutral-100">
            <img
              src="https://picsum.photos/seed/tekton/800/600"
              alt="Post content"
              className="w-full h-full object-cover"
            />
          </div>
          ...
          <div className="flex items-center justify-between pt-4 border-t border-[oklch(0.96_0.01_210)]">
            <div className="flex -space-x-4">
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="w-10 h-10 rounded-full border-4 border-white bg-[oklch(0.96_0.01_210)] flex items-center justify-center overflow-hidden shadow-sm"
                >
        ...
        <section className="flex flex-col gap-6">
          <h3 className="px-4 text-2xl font-black opacity-40 uppercase tracking-widest">
            Comments
          </h3>
                ...
                <div key={i} className="flex gap-4 px-4 py-2">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-lg font-medium opacity-70 leading-snug">
                      {i === 1
                        ? 'Absolutely love the radius on these cards! Feels so modern.'
