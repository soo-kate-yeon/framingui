        ...
        <main className={`min-h-screen py-16 px-6 font-sans`} style={{ backgroundColor: canvasColor, color: textColorPrimary }}>
            <div className="max-w-xl mx-auto flex flex-col gap-10">
                ...
                <header className="px-4 flex justify-between items-center">
                    <div>
                        <h1 className="text-5xl font-black tracking-tighter mb-2" style={{ color: textColorPrimary }}>Feed</h1>
                        <p className="text-lg font-medium opacity-60">Round Minimal Exploration</p>
                    </div>
                    <a href="/social-feed/account" className="w-16 h-16 rounded-full bg-white shadow-lg overflow-hidden flex items-center justify-center transform hover:scale-110 transition-transform active:scale-95 border-4 border-white">
                ...
                <section className="flex flex-col gap-8">
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold" style={{ color: textColorPrimary }}>Alex Doe</h3>
                        ...
                        <p className="text-xl font-medium leading-relaxed" style={{ color: textColorPrimary }}>
                            Exploring the new Tekton design system! The <span style={{ color: brandColor }}>#round-minimal</span> theme is so approachable. Chunky padding makes everything feel so tactile.
                        </p>
                    ...
                    <div className="bg-white rounded-[40px] p-10 shadow-[0_20px_50px_rgba(0,0,0,0.06)] flex flex-col gap-6 transform hover:-translate-y-1 transition-transform cursor-pointer border border-[oklch(0.50_0.25_220/0.05)]">
                        <div className="flex items-center gap-4">
                            <div className="w-14 h-14 rounded-full bg-[oklch(0.50_0.25_220/0.1)] flex items-center justify-center overflow-hidden">
                                <img src="https://i.pravatar.cc/150?u=round2" alt="Jane" className="w-full h-full object-cover" />
                            </div>
                            <div>
                                <h3 className="text-xl font-bold" style={{ color: textColorPrimary }}>Jane Smith</h3>
                                <p className="text-sm font-semibold opacity-40">5 hours ago</p>
                            </div>
                        </div>

                        <p className="text-xl font-medium leading-relaxed" style={{ color: textColorPrimary }}>
                            Maximum radius everywhere! Super-ellipse is the way to go. Friendly and modern atmosphere achieved effortlessly.
                        </p>
                ...
                <section className="bg-[oklch(0.93_0.02_210)] rounded-[32px] p-8">
                    <h3 className="text-xl font-black mb-6" style={{ color: textColorPrimary }}>JOYFUL TOPICS</h3>
                    <div className="flex flex-wrap gap-3">
                        {['#joyful_clarity', '#round_minimal', '#tekton', '#oklch'].map(tag => (
                            <span key={tag} className="bg-white text-[oklch(0.50_0.25_220)] px-6 py-3 rounded-full font-bold shadow-sm cursor-pointer hover:bg-[oklch(0.50_0.25_220)] hover:text-white transition-all">
                                {tag}
                            </span>
                        ))}
                    </div>
            ...
            <nav className="fixed bottom-8 left-1/2 -translate-x-1/2 w-[calc(100%-48px)] max-w-md bg-white/80 backdrop-blur-xl rounded-[40px] p-4 shadow-[0_20px_50px_rgba(0,0,0,0.1)] flex justify-around items-center border border-white/20">
                ...
                <a href="/social-feed/account" className="w-14 h-14 rounded-full flex items-center justify-center text-neutral-400 hover:bg-neutral-100 transition-colors">
