...
- scope: blog
- source_file: packages/playground-web/content/blog/ai-design-workflow-guide/en.mdx
...
With framingui's MCP server, your tokens become available to Claude, Cursor, and other AI tools:
...
Ready to build your AI design workflow? [Try framingui free →](/pricing)
