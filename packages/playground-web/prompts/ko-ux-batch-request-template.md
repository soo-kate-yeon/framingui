# KO UX Batch Request Template

아래 템플릿에 문자열 목록을 넣어 코딩 에이전트/LLM에 전달합니다.

## 1) System Prompt

`prompts/ko-ux-translation-system-prompt.md` 내용을 시스템 프롬프트로 사용합니다.
...
번역 반영 후 아래 명령으로 KO 톤 QC를 실행합니다.

```bash
node packages/playground-web/scripts/check-ko-ux-tone.mjs
```
