...
Tools like Style Dictionary, Tokens Studio, or tekton/ui's built-in transformer handle this automatically.
...
## Get Started with tekton/ui

tekton/ui provides a complete design token infrastructure out of the box:
