...
- **tekton-ui** implements this through a 3-layer architecture: Token Generation → Component Knowledge → AI-Powered Generation
...
```typescript
// What tekton-ui generates with full context
import { Card, Badge, DataTable, Button } from '@tekton/ui';
...
tekton-ui implements this 3-layer architecture end-to-end.
...
tekton-ui generates 100+ tokens automatically:
...
tekton-ui ships with 20+ components pre-configured with semantic metadata:
...
Use tekton-ui's MCP (Model Context Protocol) integration:
...
tekton-ui prevents design drift with **3-layer enforcement**:
...
## Getting Started with tekton-ui
...
```bash
# Install tekton-ui
npm install @tekton/core @tekton/ui @tekton/styled
...
tekton-ui works with Claude Code, Cursor, and any tool supporting MCP:
...
- [Quick Start Guide](https://tekton-ui.com/docs/quick-start) — Get up and running in 5 minutes
- [API Reference](https://tekton-ui.com/docs/api) — Complete API documentation
- [Component Catalog](https://tekton-ui.com/docs/components) — 20+ pre-built components
- [MCP Integration](https://tekton-ui.com/docs/mcp) — Connect with AI tools
...
No. Designers still make all creative decisions — color palettes, typography, component variants. tekton-ui simply automates the translation of those decisions into production code. Think of it as a compiler for design systems: designers write the spec, AI generates the implementation.

### What if I already have a design system?

tekton-ui can integrate with existing design systems. You can:
...
Yes! tekton-ui exports Tailwind-compatible configs:
...
Currently, yes. tekton-ui generates React components with TypeScript. Support for Vue, Svelte, and other frameworks is on the roadmap. However, the token generation layer (Layer 1) is framework-agnostic and outputs standard CSS variables.

## Join the Beta

tekton-ui is in public beta. We're looking for design systems teams to try it and provide feedback.
...
*Built with [tekton-ui](https://tekton-ui.com) — the agentic design system for AI-powered development.*
