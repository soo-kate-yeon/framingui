...
framingui offers flexible pricing:
- **Individual Plan**: For solo developers and indie hackers
- **Creator Plan**: For teams and agencies
- Free trial available to explore all features
...
*Built with [framingui](https://framingui.com) — Stop generating generic UI. Generate your brand.*
