...
#### Step 1: Install tekton-ui (5 minutes)
...
- tekton-ui auto-detects this if possible

#### Step 3: Review Generated Tokens (5 minutes)

tekton-ui just generated:
...
1. tekton-ui generated a 10-step color scale from your primary color
...
```bash
npm install @tekton/esbuild-plugin
```
...
const { tektonPlugin } = require('@tekton/esbuild-plugin');
...
Not sure if your colors work together? tekton-ui validates automatically:

```bash
npx @tekton/cli validate
...
**Quote:**
> "I'm not a designer, but my SaaS looks like I hired one. tekton-ui gave me a design system I could trust."
...
**Quote:**
> "tekton-ui generated accessible colors I never would have figured out on my own. It literally saved my business from an ADA lawsuit."
...
- Customize per client: `npx @tekton/cli init --brand clientA`
...
Yes. tekton-ui is designed for non-designers. You answer simple questions (what color represents your brand?), and tekton-ui handles the design math:
...
tekton-ui is **in beta** with your first template free. Pick a template, install with one command, and start building. No subscription during beta.
...
No. tekton-ui handles OKLCH internally. You can provide colors as:
- Hex: `#3B82F6`
- RGB: `rgb(59, 130, 246)`
- HSL: `hsl(217, 91%, 60%)`

tekton-ui converts to OKLCH automatically and generates WCAG-compliant scales.

### What if I'm using Tailwind CSS?

tekton-ui integrates with Tailwind:

```javascript
// tailwind.config.js (generated by tekton-ui)
module.exports = {
  theme: {
    extend: {
      colors: {
...
**Resources:**
- [Documentation](https://tekton-ui.com/docs) — Complete guides
- [Component Templates](https://tekton-ui.com/templates) — Copy-paste components
- [GitHub](https://github.com/tekton-ui) — Open-source repository
- [Discord](https://tekton-ui.com/discord) — Community help
...
*Built with [tekton-ui](https://tekton-ui.com) — Design systems for developers who code alone.*
