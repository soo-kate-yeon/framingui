...
| 플랜 | 가격 | 포함 내용 | 템플릿당 가격 |
|------|------|----------|--------------|
| **Single Template** | $59 | 선택 템플릿 1개 (1년 업데이트) | $59 |
| **Double Package** | $99 | 선택 템플릿 2개 (1년 업데이트) | $49.50 (16% 할인) |
...
- [ ] 환불정책 (Refund Policy) 명시
- [ ] 라이선스 계약서 (License Agreement)
- [ ] 업데이트 알림 이메일 시스템
